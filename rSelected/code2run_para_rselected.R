...
args <- list(c(.02, .04, .06), #increase in probability of death for uninformed
             ...
             "C:/Users/Zach/Desktop/results/rSelect", #an empty folder where results will be saved.
...
time1 <- Sys.time()
results.folders <- paste("C:/Users/Zach/Desktop/results/rSelect", paste0(1:nrow(args), gsub(":", "",strsplit(as.character(Sys.time()), " ")[[1]][2])), sep = "/")
