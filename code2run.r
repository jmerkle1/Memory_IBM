...
info.transfer.IBM(h=0.20, #increase in probability of death for uninformed
                  ...
                  infotransfer=0.1, # given an interaction, what is the probability that information is transfered (min=0, max=1)
                  ...
                  bold.distr.beta=c(1, 5), # probability of being bold, beta distribution (vector of 2 values: shape1 and shape2)
