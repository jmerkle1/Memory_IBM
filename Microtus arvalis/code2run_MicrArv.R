...
info.transfer.IBM(h=0.20, #increase in probability of death for uninformed
                  ...
                  si=2, # maximum mean (i.e., lambda of poison distribution) number of interactions per pair (if animal has 1 bold, it interacts with an animal with 1 boldness, and population is at or above K, this is the lambda of the interaction distributions)
                  ...
                  N0=200, # starting number of individuals
                  t=25, # how many years should the simulation run for?
                  sex.ratio=0.46, #what is the sex ratio of of the population/births?
                  age.distr.lamba=1.5, # lambda value for starting age distribution based on poison distribution
                  ...
                  result.folder="C:/Users/Zach/Desktop/results/MicroArv", #an empty folder where results will be saved.
...
plotSocialIBMResults(result.folder="C:/Users/Zach/Desktop/results/MicroArv")
