...
info.transfer.IBM(h=0.20, #increase in probability of death for uninformed
                  ...
                  birthdeath.file="C:/Users/Yankee/Documents/GitHub/Memory_IBM/Myotis bechsteinii/ageClass_MyotisBe.csv", #dataframe of age based birth and death rate for FEMALES only. The columns should be age, ageClass, birthRate, and survivalRate, in that order.
                  result.folder="C:/Users/Yankee/Desktop/results/MyotisBe", #an empty folder where results will be saved.
...
plotSocialIBMResults(result.folder="C:/Users/Yankee/Desktop/results/MyotisBe")
