...
info.transfer.IBM(h=0.20, #increase in probability of death for uninformed
                  ...
                  si=0, # maximum mean (i.e., lambda of poison distribution) number of interactions per pair (if animal has 1 bold, it interacts with an animal with 1 boldness, and population is at or above K, this is the lambda of the interaction distributions)
                  infotransfer=0.03, # given an interaction, what is the probability that information is transfered (min=0, max=1)
                  K=40000, # carrying capacity
                  N0=4000, # starting number of individuals
                  ...
                  result.folder="C:/Users/Zach/Desktop/results/SitoOry", #an empty folder where results will be saved.
                  ...
                  vertTransmission=0, # When giving birth, should your information status be given to your offspring? 0 if false, 1 if true (i.e., is there vertical transmission of information?)
...
plotSocialIBMResults(result.folder="C:/Users/Zach/Desktop/results/SitoOry")
