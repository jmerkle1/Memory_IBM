...
info.transfer.IBM(h=0.20, #increase in probability of death for uninformed
                  ...
                  sex.ratio=0.66, #what is the sex ratio of of the population/births?
                  ...
                  birthdeath.file="C:/Users/Zach/Documents/GitHub/Memory_IBM/Memory_IBM/Puma concolor/ageClass_PumaCo.csv", #dataframe of age based birth and death rate for FEMALES only. The columns should be age, ageClass, birthRate, and survivalRate, in that order.
                  result.folder="C:/Users/Zach/Desktop/results/PumaCo", #an empty folder where results will be saved.
...
plotSocialIBMResults(result.folder="C:/Users/Zach/Desktop/results/PumaCo")
