learning <- 
function(nl, curIndividual, ageClass, maxAgeClass = 4, is.alive, boldness, interactionMatrix, ind, densityDependType = 0, indexJ, birth = 0, memory = 0, pastInteractions, familiarBias = .1){
  ...
  if(familiarBias > 0 && birth == 0){
    socialPool$numInteractions <- socialPool$numInteractions + (pastInteractions[-indexJ] * familiarBias)
  }
