...
info.transfer.IBM(h=0.20, #increase in probability of death for uninformed
                  ...
                  age.distr.lamba=7.3, # lambda value for starting age distribution based on poison distribution
                  ...
                  birthdeath.file="C:/Users/Zach/Documents/GitHub/Memory_IBM/Memory_IBM/Corvus kubaryi/ageClass_CorvKuba.csv", #dataframe of age based birth and death rate for FEMALES only. The columns should be age, ageClass, birthRate, and survivalRate, in that order.
                  result.folder="C:/Users/Zach/Desktop/results/Corv_kuba", #an empty folder where results will be saved.
...
plotSocialIBMResults(result.folder="C:/Users/Zach/Desktop/results/Corv_kuba")
